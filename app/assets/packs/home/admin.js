...
if (document.querySelectorAll(".admin-page").length > 0) {
  createDonutChart('#syn-chart', species_types)
  createDonutChart('#sources-chart', species_sources)
  createDonutChart('#type-chart', stats)
}
